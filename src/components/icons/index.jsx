...
// Инструменты — перо: приложение про письмо, и гаечный ключ в нём
// выглядел деталью из чужого набора.
export function IconTools({ size }) {
  return (
    <Svg size={size}>
      <path d="M8 14.6 4.5 6.1a2.6 2.6 0 0 1 1.1-3.2L8 1.4l2.4 1.5a2.6 2.6 0 0 1 1.1 3.2z" />
      <path d="M8 9.2v5.4" />
...
// Типограф — кавычки-ёлочки, как и было.
// Каждая ёлочка из двух шевронов: одиночный угол читался бы как «Код».
export function IconTypograf({ size }) {
  return (
    <Svg size={size}>
      <path d="M4.2 4.6 2.2 8l2 3.4" />
      <path d="M7.2 4.6 5.2 8l2 3.4" />
      <path d="M8.8 4.6 10.8 8l-2 3.4" />
      <path d="M11.8 4.6 13.8 8l-2 3.4" />
    </Svg>
  )
}
