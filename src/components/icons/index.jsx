...
// Стопка листов. Раньше здесь был гамбургер, который читается как «главное меню».
export function IconDocs({ size }) {
  return (
    <Svg size={size}>
      <rect x="2.2" y="1.8" width="8.6" height="10.4" rx="1.2" />
      <path d="M5.2 14.2h7.6a1.2 1.2 0 0 0 1.2-1.2V4.6" />
    </Svg>
  )
}
...
// Инструменты — единственное место в приложении, где остаётся ключ.
...
// Поделиться: системный символ macOS. Приложение живёт в macOS-контексте,
// андроидный «граф из трёх узлов» здесь читается хуже.
export function IconShare({ size }) {
  return (
    <Svg size={size}>
      <path d="M8 1.8v8.4" />
      <path d="M5.2 4.6 8 1.8l2.8 2.8" />
      <path d="M4.6 7.4H3.2a1.2 1.2 0 0 0-1.2 1.2v4.4a1.2 1.2 0 0 0 1.2 1.2h9.6a1.2 1.2 0 0 0 1.2-1.2V8.6a1.2 1.2 0 0 0-1.2-1.2h-1.4" />
    </Svg>
  )
}
...
// Типограф: кавычки-ёлочки над строкой текста.
// Ёлочки залиты, а не обведены: в контуре они превращаются в угловые скобки
// и становятся неотличимы от иконки «Код».
export function IconTypograf({ size }) {
  return (
    <Svg size={size}>
      <path d="M6.6 3 3.4 7l3.2 4z" fill="currentColor" stroke="none" />
      <path d="M9.4 3 12.6 7l-3.2 4z" fill="currentColor" stroke="none" />
