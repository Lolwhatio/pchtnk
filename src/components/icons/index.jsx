...
// Невидимые символы: перечёркнутый глаз — то, чего не видно, убирают.
// Зрачок точкой, а не окружностью: контур на 16 пикселях слипается в пятно.
export function IconInvisible({ size }) {
  return (
    <Svg size={size}>
      <path d="M2 8.5c1.6-2.5 3.6-3.8 6-3.8s4.4 1.3 6 3.8" />
      <path d="M5.9 10.9c.6.4 1.3.6 2.1.6s1.5-.2 2.1-.6" />
      <circle cx="8" cy="9.4" r="0.4" fill="currentColor" stroke="none" />
      <path d="M3.2 13.4 12.8 3.8" />
    </Svg>
  )
}
